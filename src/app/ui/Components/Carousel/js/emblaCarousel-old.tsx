...
import { useAppContext } from "@/app/ui/Components/AppContext";
import data from "@/app/ui/JSONs/text.json";
import { CarouselProps } from "@/app/ui/types";
...
const carouselMap = ({ slides }: CarouselProps) => {
	slides.map((slide) => (
		<Image
			src={slide.carouselImg}
			alt={slide.carouselAlt}
			height={1000}
			width={1000}
...
const EmblaCarousel: React.FC<PropType> = (props) => {
	...
	return (
		<section className="embla z-0  mx-auto">
			...
			<div className="embla__controls mx-3 my-4">
